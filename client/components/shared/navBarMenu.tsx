    ...
    <nav className="w-full border-b border-gray-200 bg-white/80 backdrop-blur-md shadow-sm">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3 sm:px-6 lg:px-8">
        ...
        <div className="hidden items-center gap-6 sm:flex">
          ...
          <SignedIn>
            <Link href={`/user/${curUser?.id}`} className="cursor-pointer text-gray-700 hover:text-gray-400 transition-colors flex items-center gap-2 text-xl">My Account</Link>
